...
<Row>
  <Col style={{backgroundColor:'rgb(235, 235, 235)'}}>
    <center>
   <Image height={90} width={90}  src="https://assets-in.bmscdn.com/m6/images/common/placeholder.png" 
    />
   </center>
    </Col>
</Row>
    ...
    <div className={style.d}>Jatt Nu Chudail Takri</div>
     <div className={style.v}>Comedy</div > 
        </Col>
...
<Col>
    ...
    <div className={style.v}>Thriller</div>
    </Col>


    <Col>
    <Card style={{border:'10px'}}>
      <Card.Img variant="top"  alt="Kung Fu Panda 4" width="100%" height="100%"   src="https://assets-in.bmscdn.com/discovery-catalog/events/tr:w-400,h-600,bg-CCCCCC:w-400.0,h-660.0,cm-pad_resize,bg-000000,fo-top:l-image,i-discovery-catalog@@icons@@star-icon-202203010609.png,lx-24,ly-615,w-29,l-end:l-text,ie-OC41LzEwICAxMC42SyBWb3Rlcw%3D%3D,fs-29,co-FFFFFF,ly-612,lx-70,pa-8_0_0_0,l-end/et00379741-rxxpavyhrq-portrait.jpg"
       style={{borderRadius:"10px"}}/>
    </Card>
    <div className={style.d}>Kung Fu Panda 4</div>
    <div className={style.v}>Action/Adventure/Comedy</div>
    </Col>
    </Row>
    </Container>
    </Carousel>
...
<Row>
  <Col>
  <Card style={{paddingTop:'5%',border:'10px'}}>
