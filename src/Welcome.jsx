 ...
 <Navbar expand="lg">
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav className="me-auto" >
            <Nav.Link href="/Aboutus" style={{color:"white",fontSize:"20px"}}>Aboutus</Nav.Link>
            
          </Nav>
          <Nav>
          <Nav.Link href="/Login" style={{marginRight:'20px'}}>
         <Button  variant='danger' size='sm' onClick={()=>{}} style={{width:'70px'}}>Login</Button>{' '}
   </Nav.Link>
          <Nav.Link href="/Signup" style={{marginRight:'30px'}}>
         <Button  variant='danger' size='sm' onClick={()=>{}}>Sign Up</Button>{' '}
   </Nav.Link>
          </Nav>
        </Navbar.Collapse>
     </Navbar>
   ...
   <div >Bookmyshow is an online portal that helps you book tickets for movies.</div>
